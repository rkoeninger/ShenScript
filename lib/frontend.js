...
const {
  Await, Binary, Call, Class, Debugger, Generator, Id, Literal, Member, NewTarget,
  Procedure, Return, Slot, Spread, Super, This, Unary, Yield, YieldMany,
  ann
} = require('./ast');
...
module.exports = $ => {
  ...
  inline('js.this',                    () => This);
  inline('js.super',                 args => Super([Spread(Call(Member(Id('$'), Id('valueToArray')), args, async))]));
