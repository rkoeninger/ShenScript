...
// TODO: bounce curried applications?
...
const funAsync = (f, arity) =>
  async (...args) =>
    args.length === arity ? f(...args) :
    args.length > arity ? asFunction(await settle(f(...args.slice(0, arity))))(...args.slice(arity)) :
...
module.exports = (options = {}) => {
  ...
  const $ = {
    ...
    symbolOf, nameOf, valueOf, show, equate, raise, fun, bounce, settle, assemble, construct, compile, defun,
