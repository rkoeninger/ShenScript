...
module.exports = $ => {
  ...
  define('js.unchecked.!=',                           (x, y) => x != y);
  define('js.unchecked.!==',                          (x, y) => x !== y);
  define('js.unchecked.not',                               x => !x);
  define('js.unchecked.and',                          (x, y) => x && y);
  define('js.unchecked.or',                           (x, y) => x || y);
  define('js.unchecked.+',                            (x, y) => x + y);
  define('js.unchecked.-',                            (x, y) => x - y);
  define('js.unchecked.*',                            (x, y) => x * y);
  define('js.unchecked./',                            (x, y) => x / y);
  ...
  inline('js.unchecked.and', (x, y) => Binary('&&', x, y));
  inline('js.unchecked.or',  (x, y) => Binary('||', x, y));
