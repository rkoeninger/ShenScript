...
module.exports = $ => {
  ...
  inline('js.constructor',        body => Slot('constructor', Id('constructor'), body));
  inline('js.method',       (id, body) => Slot('method', id, body));
  inline('js.getter',       (id, body) => Slot('get', id, body));
  inline('js.setter',       (id, body) => Slot('set', id, body));
