...
module.exports = {
  ...
  Generator, Id, If, Let, Literal, Local, Member, New, NewObj, NewTarget, Procedure, Program, Property,
  Return, SafeId, Sequence, Slot, Spread, Statement, Static, Super, TaggedTemplate, Template, TemplateElement,
  TemplateLiteral, This, Try, Unary, Var, Vector, While, Yield, YieldMany,
  anyAwaits, generate
};
