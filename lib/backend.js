...
module.exports = (options = {}) => {
  ...
  // TODO: need better way to distinguish between statements and expressions
  //       Id counts as an expression, VariableDeclaration counts as a statement
  //       and you don't need to Return a Return or Block a Block
  const evalJs = ast => F('$', generate(ast.type.includes('Statement') ? Block(ast) : Return(ast)))($);
