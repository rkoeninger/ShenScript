...
const SafeId = sym => ({ type: 'Identifier', name: escapeName(Symbol.keyFor(sym)) }); // TODO: check for keywords?
...
module.exports = {
  ...
  Generator, Id, If, Let, Literal, Local, Member, New, NewTarget, Procedure, Program, RawId,
