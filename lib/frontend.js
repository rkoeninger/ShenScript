...
const {
  Await, Binary, Call$, Class, Debugger, Generator, Literal, NewTarget, Procedure,
  RawId, Return, Slot, Spread, Super, This, Unary, Yield, YieldMany,
  ann
} = require('./ast');
...
module.exports = $ => {
  ...
  inline('js.arguments',               () => RawId('arguments'));
  ...
  inline('js.constructor',           body => Slot(false, 'constructor', RawId('constructor'), body));
