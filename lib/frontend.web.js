...
module.exports = async $ => {
  const {
    asShenBool, asString, async, caller, define, defineTyped, eternal, evalJs, inline,
    isArray, nameOf, raise, run, s, symbol, symbolOf, toArray, toArrayTree, toList, valueOf
  } = $ = await frontend($);
