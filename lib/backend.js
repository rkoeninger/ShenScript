...
const {
  Arrow, Assign, Binary, Block, Call, Conditional, Id, Literal,
...
const toList      = (a, z = null) => isArray(a) ? a.reduceRight((t, h) => cons(h, t), z) : a;
const toListTree  = a => isArray(a) ? toList(a.map(toListTree)) : a;
