...
const SafeId = (sym, suffix = '') => Id(escapeName(Symbol.keyFor(sym)) + suffix); // TODO: check for keywords?
...
const ann = (dataType, ast) => Object.assign(ast, { dataType }); // TODO: add some type-propogation in here like for Conditional and Sequence
