...
module.exports = $ => {
  ...
  inline('js.return',                 arg => Return(arg)); // TODO: this won't work unless let's are inlined
  inline('js.yield',                  arg => Yield(arg)); // TODO: this won't work unless let's are inlined
  inline('js.yield*',                 arg => YieldMany(arg)); // TODO: this won't work unless let's are inlined
  inline('js.await',                  arg => Await(arg)); // TODO: this won't work unless let's are inlined
  ...
  (js.constructor Name (js.function* [X Y]
    (do (js.yield X)
        (js.yield Y))))

  (js.defclass Thing extends (js.Object)
    (constructor X -> )
    (method name X Y -> )
    (get name -> )
    (set name X -> ))
