...
const frontend = $ => {
  const {
    asCons, asNumber, asJsBool, asShenBool, asString, async, compile, cons, consToArray, evalJs, fun, functions,
    future, inlines, isArray, preprocessors, s, settle, symbolOf, symbols, valueOf, valueFromArrayTree,
    valueToArrayTree
  } = $;
