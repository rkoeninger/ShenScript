...
const { AsyncFunction, GeneratorFunction, last, mapAsync, pairs, raise } = require('./utils');
const {
...
const frontend = $ => {
  const {
    asCons, asNumber, asJsBool, asList, asShenBool, asString, async, compile, cons, consToArray, evalJs,
    fun, functions, future, inlines, isArray, preprocessors, s, settle, symbolOf, symbols, valueOf,
